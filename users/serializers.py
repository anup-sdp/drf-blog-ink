...
class CustomUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ["id","username","email","phone_number","location","bio","profile_picture","is_active","is_staff",]
        read_only_fields = ["id"]

    def get_fields(self):
        """
        Make is_active and is_staff editable only for staff users.     
        """
...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ["username", "email", "password", "phone_number", "location", "bio", "profile_picture"]
